...
const SignUp = ({navigation}) => {
  ...
  const onSubmit = () => {
    if (toggleCheckBox && name && email && password) {
      ...
      Alert.alert(
        'Form Not Fill',
        'Name, Email, Password Must be fulfilled and Accept Terms and Conditions',
      );
    }
  };
          ...
          <ScrollView style={{height: '100%', backgroundColor: style.white}}>
            <View style={styles.container}>
              ...
              <View style={{marginTop: 40}}>
                ...
                <RectButton
                  onPress={onSubmit}
                  style={name < 1 || email < 1 || password < 1 ? styles.buttonDisable : styles.button}
                  enabled={
                    name < 1 || email < 1 || password < 1 ? false : true
                  }>
                  <Text
                    style={{
                      textAlign: 'center',
                      color: name < 1 || email < 1 || password < 1  ? style.dark:style.white,
                      fontSize: 18,
                      fontWeight: 'bold',
                    }}>
                    Sign Up
